                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="celular"  class="form-control" name="celular" required autocomplete="celular">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="wallet"  class="form-control" name="wallet" required autocomplete="wallet">
                            </div>
                        </div>
